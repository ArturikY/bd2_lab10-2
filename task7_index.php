<?php
// Задание 7: Триггер блокировки устройства при частых обращениях
...
foreach ($devices as $device_id) {
    ...
    if ($is_blocked) {
        // Показываем предупреждение о подозрительном поведении устройства
        echo '<div class="device-block blocked-device">
            <h2>Устройство: ' . htmlspecialchars($device['device_name']) . ' (ID: ' . $device_id . ')</h2>
        ...
        // Показываем нормальное устройство с возможностью управления
